...
| `references/brief-contract.md`       | the brief's ground rules — mode derivation (collaborative / autonomous), shared field registry, and question invariants; VidMuse product skills own all briefs |
