...
> **VidMuse plugin:** for packaging existing speaking footage, `/vidmuse-recut` owns transcript alignment (user-supplied text + VidMuse ATA) and delivery captions strategy. Use this skill for BGM/SFX/assets/grade and other media ops *inside* a recut run — do not take over the product workflow.
