...
- Let `vidmuse-cli` resolve or install the official CLI, pin production, validate the account, and own flags, dependencies, process execution, and output parsing.
