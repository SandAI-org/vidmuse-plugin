...
- Visual style, layout, and frame library
...
The VidMuse owner confirms the input clip. Aspect, layout, style group, and card count stay at Step 7, where probed footage and transcript ground the recommendations.
