...
- Let `vidmuse-mv` own a complete generative film when an uploaded or newly generated song is the immutable master timeline; music used only as support stays here.
