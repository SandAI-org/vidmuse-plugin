...
> **VidMuse extract** from [video-shotcraft](https://github.com/Vincentwei1021/video-shotcraft) `references/shots/slam-entrance-moves.md` (Apache-2.0). Motion intent + parameters only. **Implement in HyperFrames/GSAP** — do not run Remotion demos. Preview: https://vincentwei1021.github.io/video-shotcraft/
